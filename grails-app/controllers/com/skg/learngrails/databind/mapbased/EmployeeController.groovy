...
class EmployeeController {
    ...
    @Transactional
    def save() {
        def bindingMap = [empID: params.empID, name: params.name, department: [depID: '111', name: 'java'] ]

        def employeeInstance = new Employee(bindingMap)
        if (employeeInstance.hasErrors()) {
            respond employeeInstance.errors, view: 'create'
            return
        }

        employeeInstance.department.save flush: true
