	...
	<body>
		...
		<div id="show-department" class="content scaffold-show" role="main">
			...
			<ol class="property-list department">
				...
				<g:if test="${departmentInstance?.depId}">
				<li class="fieldcontain">
					<span id="depId-label" class="property-label"><g:message code="department.depId.label" default="Dep Id" /></span>
					
						<span class="property-value" aria-labelledby="depId-label"><g:fieldValue bean="${departmentInstance}" field="depId"/></span>
