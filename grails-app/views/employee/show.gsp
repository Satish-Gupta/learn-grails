		...
		<div id="show-employee" class="content scaffold-show" role="main">
			...
			<ol class="property-list employee">
				...
				<li class="fieldcontain">
					<span id="empID-label" class="property-label"><g:message code="employee.empID.label" default="Emp ID" /></span>
				...
				<li class="fieldcontain">
					<span id="joinDate-label" class="property-label"><g:message code="employee.joinDate.label" default="Join Date" /></span>
						...
						<span class="property-value" aria-labelledby="joinDate-label"><g:fieldValue bean="${employeeInstance}" field="joinDate"/></span>
				...
				<li class="fieldcontain">
					<span id="department-label" class="property-label"><g:message code="employee.department.label" default="Department" /></span>
						...
						<span class="property-value" aria-labelledby="department-label"><g:fieldValue bean="${employeeInstance}" field="department"/></span>
				...
				<li class="fieldcontain">
					<span id="project-label" class="property-label"><g:message code="employee.project.label" default="Project" /></span>
						...
						<span class="property-value" aria-labelledby="project-label"><g:fieldValue bean="${employeeInstance}" field="project"/></span>
