		...
		<div id="list-album" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="numberOfTracks" title="${message(code: 'album.numberOfTracks.label', default: 'Number Of Tracks')}" />
				...
				<g:each in="${albumInstanceList}" status="i" var="albumInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${albumInstance.id}">${fieldValue(bean: albumInstance, field: "numberOfTracks")}</g:link></td>
