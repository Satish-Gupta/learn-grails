	...
	<body>
		...
		<div id="show-student" class="content scaffold-show" role="main">
			...
			<ol class="property-list student">
				...
				<g:if test="${studentInstance?.roll}">
				<li class="fieldcontain">
					<span id="roll-label" class="property-label"><g:message code="student.roll.label" default="Roll" /></span>
					
						<span class="property-value" aria-labelledby="roll-label"><g:fieldValue bean="${studentInstance}" field="roll"/></span>
